    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Ajouter Medecin </li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>ajouter/Doc">
                    <div class="space"></div>
                    ...
                    <?= $Tel; ?>
                     <div class="space"></div>
                     <h4 class="header blue bolder smaller">compte utilisateur</h4>
                        <?=$user ;?>
                        <?=$pass; ?>
                    <div class="space"></div>
                    ...
                    <?= $j; ?>
                    <div id="contrat"></div>
                    <button class="btn btn-primary-outline"type="button" onclick="ajouterContrat()">Ajouter d'autre engagement</button>
