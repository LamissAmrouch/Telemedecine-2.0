                                ...
                                <div class="tab-content no-border padding-24">
                                    <div id="home" class="tab-pane active">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-3 center">
                                                ...
                                                <a href="<?php echo base_url();?>/Doctor/AjouterDispo/<?=$Medecin->NSS ;?>" class="btn btn-sm btn-block btn-primary">
                                                    <i class="ace-icon fa fa-calendar bigger-110"></i>
                                                    <span class="bigger-110">Déclarer Date libre</span>
                                                </a>
                                            </div><!-- /.col -->
                                            ...
                                            <div class="col-xs-12 col-sm-9">
                                                ...
                                                <div class="profile-user-info">
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <a href="https://<?=$Medecin->Site;?>" target="_blank"><?= $Medecin->Site ;?></a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <a href="https://<?=$Medecin->facebook ;?>">Find me on Facebook</a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            <a href="https://<?=$Medecin->twitter ;?>">Follow me on Twitter</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- /.col -->
                                    ...
                                    <div id="feed" class="tab-pane">
                                        <div class="profile-feed row">
                                            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>Modifier/Myinfo" onsubmit="return validation()">
                                                <?= $Nss; ?>
                                                <?= $Nom; ?>
                                                <?= $Prenom; ?>
                                                <?= $Mail; ?>
