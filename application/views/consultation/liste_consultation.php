	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Liste des Consultations </li>
			</ul><!-- /.breadcrumb -->
 ...
 <input type="text" id="N_ss" name="codeP" class="col-xs-12 col-sm-5" placeholder="Introduire le code patient " />
    ...
    <!-- div.dataTables_borderWrap -->
        ...
        <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
            ...
            <tbody id="tableCore">
            <?php foreach ($Consultation as $consultation) : ?>
                <tr class="odd" role="row">


                    <td>
                        <a class="a" href="get_patient_profile/<?= $consultation->id_patient; ?>"><?= $consultation->id_patient; ?></a>
                    </td>

                     <td>
                        <a class="a" href="get_information_consultation/<?= $consultation->id_cons; ?>"><?= $consultation->id_cons; ?></a>
                    </td>

                    
                    <td class="sorting_1"><?= $consultation->date_cons; ?></td>
